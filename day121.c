/*Task-2 with pthread conditional lock:


LCD-- (cond1)condition lock...

Monitor -- (cond1)condition  lock 

	-- if outof control..
	-- signal to main (cond2).

	
Sensor (cond1)  sending signal on cond1

	-- writing

	-- signal to LCD/Monitoring..*/
	#include <pthread.h>
#include <stdio.h>
#include <unistd.h>
#include <assert.h>
